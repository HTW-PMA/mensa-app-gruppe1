...
function __VLS_template() {
    ...
    [RouterLink, RouterLink,];
    // @ts-ignore
    const __VLS_25 = __VLS_asFunctionalComponent(__VLS_24, new __VLS_24({ to: ("/gericht-list"), }));
    const __VLS_26 = __VLS_25({ to: ("/gericht-list"), }, ...__VLS_functionalComponentArgsRest(__VLS_25));
    ({}({ to: ("/gericht-list"), }));
