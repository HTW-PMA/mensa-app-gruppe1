...
function __VLS_template() {
    ...
    if (__VLS_ctx.width > __VLS_ctx.SMALL_BREAKPOINT) {
        ...
        [RouterLink, RouterLink,];
        // @ts-ignore
        const __VLS_13 = __VLS_asFunctionalComponent(__VLS_12, new __VLS_12({ to: ("/about"), }));
        const __VLS_14 = __VLS_13({ to: ("/about"), }, ...__VLS_functionalComponentArgsRest(__VLS_13));
        ({}({ to: ("/about"), }));
        ...
        [UserIcon, UserIcon,];
        // @ts-ignore
        const __VLS_24 = __VLS_asFunctionalComponent(UserIcon, new UserIcon({}));
        const __VLS_25 = __VLS_24({}, ...__VLS_functionalComponentArgsRest(__VLS_24));
        ({}({}));
        const __VLS_28 = __VLS_pickFunctionalComponentCtx(UserIcon, __VLS_25);
    ...
    if (__VLS_ctx.width < __VLS_ctx.SMALL_BREAKPOINT) {
        ...
        [RouterLink, RouterLink,];
        // @ts-ignore
        const __VLS_30 = __VLS_asFunctionalComponent(__VLS_29, new __VLS_29({ to: ("/"), }));
        const __VLS_31 = __VLS_30({ to: ("/"), }, ...__VLS_functionalComponentArgsRest(__VLS_30));
        ({}({ to: ("/"), }));
        // @ts-ignore
        [HomeIcon, HomeIcon,];
        // @ts-ignore
        const __VLS_35 = __VLS_asFunctionalComponent(HomeIcon, new HomeIcon({}));
        const __VLS_36 = __VLS_35({}, ...__VLS_functionalComponentArgsRest(__VLS_35));
        ({}({}));
        // @ts-ignore
        [width, SMALL_BREAKPOINT,];
        const __VLS_39 = __VLS_pickFunctionalComponentCtx(HomeIcon, __VLS_36);
        ...
        [RouterLink, RouterLink,];
        // @ts-ignore
        const __VLS_41 = __VLS_asFunctionalComponent(__VLS_40, new __VLS_40({ to: ("/mensa-list"), }));
        const __VLS_42 = __VLS_41({ to: ("/mensa-list"), }, ...__VLS_functionalComponentArgsRest(__VLS_41));
        ({}({ to: ("/mensa-list"), }));
        // @ts-ignore
        [ListIcon, ListIcon,];
        // @ts-ignore
        const __VLS_46 = __VLS_asFunctionalComponent(ListIcon, new ListIcon({}));
        const __VLS_47 = __VLS_46({}, ...__VLS_functionalComponentArgsRest(__VLS_46));
        ({}({}));
        const __VLS_50 = __VLS_pickFunctionalComponentCtx(ListIcon, __VLS_47);
        ...
        [RouterLink, RouterLink,];
        // @ts-ignore
        const __VLS_52 = __VLS_asFunctionalComponent(__VLS_51, new __VLS_51({ to: ("/settings"), }));
        const __VLS_53 = __VLS_52({ to: ("/settings"), }, ...__VLS_functionalComponentArgsRest(__VLS_52));
        ({}({ to: ("/settings"), }));
        // @ts-ignore
        [UserIcon, UserIcon,];
        // @ts-ignore
        const __VLS_57 = __VLS_asFunctionalComponent(UserIcon, new UserIcon({}));
        const __VLS_58 = __VLS_57({}, ...__VLS_functionalComponentArgsRest(__VLS_57));
        ({}({}));
        const __VLS_61 = __VLS_pickFunctionalComponentCtx(UserIcon, __VLS_58);
